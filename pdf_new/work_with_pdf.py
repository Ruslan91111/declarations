...
from ammendments_to_pdf import append_tech_regulations, append_OGRN_INN, \
    ...
    separate_int_and_str, remove_space_in_phone_number, remove_substrings
...
def find_all_items_in_text(text: str, keys: list):
...
def convert_pdf_to_dict(pdf_path: str = PDF_PATH) -> dict:
    ...
    dict_result = find_all_items_in_text(str_pdf, columns)
